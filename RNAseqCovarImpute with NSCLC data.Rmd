...
Data processing
Data come from EMBL-EBI: E-GEOD-81089. I renamed the experiment-design.tsv file as "covariates.tsv" and the raw-counts file as "raw-counts.tsv"
```{r}
...
counts <- read_tsv("./raw-counts.tsv") %>%
  dplyr::rename(
    "ENSEMBL" = "Gene ID",
    "SYMBOL" = "Gene Name"
  )
