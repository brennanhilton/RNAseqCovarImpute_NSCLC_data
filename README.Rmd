...
Then run the "RNAseqCovarImpute with NSCLC data plot.Rmd" file. It includes code for plotting the results (stored in the data folder) in terms of true positive rate (TPR), false positive rate (FPR), and mean absolute percentage error (MAPE).
